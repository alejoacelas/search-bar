...
See [Search landscape](research/README.md) for the current repository survey, adoption order, and reusable list of AI-tool builders to watch.
...
|---|---|---|
| `collector/whatsapp-mcp/` | public | [lharries/whatsapp-mcp](https://github.com/lharries/whatsapp-mcp) |
